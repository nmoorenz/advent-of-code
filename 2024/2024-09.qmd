...
new_map = deepcopy(long_map)
iter = 0
file_pos = len(new_map)
...
while True:
    ...
    # do the replacement
    new_map[gap_num:gap_num+file_len] = file_val
    
    # remove the values if we were able to move
    
    # find the next value
    # this could be at the start of the loop?
