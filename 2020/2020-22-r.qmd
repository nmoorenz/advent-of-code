...
my_file <- here::here("2020", "data-2020-22.txt")
...
make a function that we can send two hands of cards to \# need to create a check on current card and length of remaining hand
